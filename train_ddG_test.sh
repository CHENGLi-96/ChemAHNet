...
SCRIPT=main_ddGgit.py              # Your main Python script
MODE=test                         # test mode
LOG_FILE=demo_Major_test.log            # output log file
...
echo "Running model in test mode..."
python $SCRIPT --local_rank 0 --$MODE \
--batch_size 64 --dropout=0.2 --num_heads 8 --num_layers 7 \
