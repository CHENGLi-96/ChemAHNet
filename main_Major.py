...
def load_data(args, name):
    ...
    data_loader = DataLoader(full_dataset,
                             ...
                             shuffle=(name == 'train_double_pdata'),
...
if __name__ == '__main__':
    ...
    if args.train:
        train_dataloader = load_data(args, 'train_double_pdata')
        valid_dataloader = load_data(args, 'eval_double_pdata')
    # if args.test:
        test_dataloader = load_data(args, 'test_double_pdata')
